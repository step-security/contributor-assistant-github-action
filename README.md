...
![add-cla-file](https://github.com/step-security/contributor-assistant-github-action/blob/main/images/adding-clafile.gif?raw=true)
...
![signature-process](https://github.com/step-security/contributor-assistant-github-action/blob/main/images/signature-process.gif?raw=true)
...
![signature-storage-file](https://github.com/step-security/contributor-assistant-github-action/blob/main/images/signature-storage-file.gif?raw=true)
...
![allowlist](https://github.com/step-security/contributor-assistant-github-action/blob/main/images/allowlist.gif?raw=true)
...
![personal-access-token](https://github.com/step-security/contributor-assistant-github-action/blob/main/images/personal-access-token.gif?raw=true)
...
| --------------------- | ----------- | ----------- |----------------------------------------------------------------------------------------|
| `path-to-document`     | _required_ |  provide full URL `https://<clafile>` to the document which shall be signed by the contributor(s)  It can be any file e.g. inside the repository or it can be a gist. | https://github.com/step-security/cla-assistant-github-action/blob/main/SAPCLA.md       |
...
| `allowlist`   | _optional_ | You can specify users and bots to be [added in allowlist](https://github.com/step-security/cla-assistant-github-action#5-users-and-bots-in-allowlist).  | user1,user2,bot*                                                                       |
